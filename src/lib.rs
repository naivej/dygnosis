...
pub use mcp::{
    ...
    dynare_explain, dynare_find_references, dynare_format, dynare_list_diagnostic_codes,
    dynare_list_options, dynare_model_info, dynare_related_files, dynare_rename,
    registered_tool_names, tools_list_json, DiagnosticCodeItem, McpDiagnostic, McpReference,
    McpWorkspaceReference,
};
pub use model::{
