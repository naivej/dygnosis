...
Move the call out of the ``steady_state(…)`` operator.",
    ...
    ("S012", ExplainEntry {
        ...
        body: "Dynare refuses: `PAC/TCM rewrite messages`. Catching step: transform (rewrite). Owner: skip-rewrite E; 0.8 probed this case without an internal source mapping. This code is never emitted.",
        kind: ExplainKind::Skipped,
    }),
    ("S014", ExplainEntry {
        title: "Remaining pac_expectation after substitution",
        body: "Dynare refuses: `unknown pac_model / no matching pac_target_info`. Catching step: transform (rewrite). Owner: skip-rewrite E; 0.8 probed this case without an internal source mapping. This code is never emitted.",
        kind: ExplainKind::Skipped,
    }),
    ("S020", ExplainEntry {
