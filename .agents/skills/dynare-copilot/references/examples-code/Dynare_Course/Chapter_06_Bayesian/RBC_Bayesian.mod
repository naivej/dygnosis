...
//set shock variances
shocks;
    var eps_z=1; //0.0068^2 in data
    var eps_g=1; //0.0105^2 in data
end;
...
//run estimation
estimation(datafile=first_diff,mh_jscale=1.5,mode_check,mode_check_symmetric_plots=1,prior_trunc=0,mh_replic=10000,mh_nblocks=2,smoother,moments_varendo,raftery_lewis_diagnostics,forecast=8,bayesian_irf,tex) log_y  ghat;
