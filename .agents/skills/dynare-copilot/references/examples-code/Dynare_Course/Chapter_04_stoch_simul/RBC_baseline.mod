...
/*
 * Copyright (C) 2016-2025 Johannes Pfeifer
 *
...
stoch_simul(order=1,irf=40,hp_filter=1600,conditional_variance_decomposition=[4],tex) LOG_y LOG_k LOG_c LOG_l LOG_w r z ghat;