 ...
 *
 *  - The planner weights are based on a second order approximation to the welfare function
 ...
 *      present in case of a distorted steady state need to be dropped. 
 *
...
discretionary_policy(instruments=(r),planner_discount=beta,planner_discount_latex_name=$\beta$); 
