...
% =========================================================================
% Specify which parameters you want to check identification for 
% =========================================================================
estimated_params;
  PSI,   1.1, NORMAL_PDF, 1.1, 0.01; %need to fix if only observing x
...
varobs x;
identification;
%identification(advanced=ior_mc=10);