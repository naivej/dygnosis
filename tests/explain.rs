...
const RUST_CODES: &[&str] = &[
    ...
    "E212", "E213", "E214", "E215", "E216", "E217", "E218", "E999", "I050", "S001", "S002", "S003", "S004", "S005", "S006", "S007", "S008", "S009", "S010",
...
const THIN_CODES: &[&str] = &[
    ...
    "E217", "E218", "E999", "I050", "W010", "W011", "W012",
...
const EMIT: &[&str] = &[
    ...
    "E179", "E180", "E181", "E182", "E183", "E184", "E185", "E200", "E201", "E202", "E203", "E204",
    "E205", "E206", "E207", "E208", "E209", "E210", "E211", "E212", "E213", "E214", "E215", "E216",
    "E217", "E218", "W022", "W031", "W042", "W121", "W131",
    "W150", "W170", "W200",
];
...
fn known_codes_is_exactly_the_163_rust_keys() {
    ...
    assert_eq!(RUST_CODES.len(), 163);
    assert_eq!(known_codes(), RUST_CODES);
    assert_eq!(known_codes().len(), 163);
...
fn cli_explain_list() {
    ...
    assert_eq!(
        ...
        Some("163 codes. Run `dygnosis explain <CODE>` for details.")
    );
