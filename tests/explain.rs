...
const RUST_CODES: &[&str] = &[
    ...
    "E999", "I050", "S001", "S002", "S003", "S004", "S005", "S006", "S007", "S008", "S009", "S010",
    "S011", "S012", "S013", "S014", "S015", "S016", "S017", "S018", "S019", "S020", "S021", "S022",
    "S023", "S024", "S025", "S026", "S027", "S028", "S029", "S030", "S031", "S032", "S033", "S034",
    "S035", "S036", "S037", "S038", "S039", "S040", "S041", "S042", "S043", "S044", "S045", "S046",
    "S047", "S048", "S049", "S050", "S051", "S052", "S053", "S054", "S055", "S056", "S057", "S058",
    "S059", "S060", "W010", "W011", "W012", "W013", "W020", "W022", "W031", "W042", "W051", "W052",
    "W054", "W055", "W056", "W057", "W060", "W061", "W062", "W070", "W091", "W092", "W094", "W102",
    "W110", "W112", "W120", "W121", "W122", "W131", "W140", "W150", "W160", "W170", "W186",
];
...
const EMIT: &[&str] = &[
    ...
    "E061", "E062", "E063", "E064", "E065", "E090", "E093", "E095", "E100", "E101", "E103", "E104",
    "E111", "E113", "E130", "E170", "E171", "E172", "E173", "E174", "E175", "E176", "E177", "E178",
    "E179", "E180", "E181", "E182", "E183", "E184", "E185", "W022", "W031", "W042", "W121", "W131",
    "W150", "W170",
];
...
#[test]
fn known_codes_is_exactly_the_143_rust_keys() {
    assert_eq!(EMIT.len(), 50);
    assert_eq!(ADDED.len(), 27);
    assert_eq!(SKIP_KEYS.len(), 66);
    assert_eq!(THIN_CODES.len(), 77);
    assert_eq!(RUST_CODES.len(), 143);
    assert_eq!(known_codes(), RUST_CODES);
    assert_eq!(known_codes().len(), 143);
...
fn cli_explain_list() {
    ...
    assert_eq!(
        ...
        Some("143 codes. Run `dygnosis explain <CODE>` for details.")
    );
