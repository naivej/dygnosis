...
const RUST_CODES: &[&str] = &[
    ...
    "E427", "E428", "E429", "E430", "E431", "E999", "I050", "S008", "S009", "S010", "S011", "S012",
    "S013", "S014", "S020", "S035", "S038", "S040", "S053", "S054", "S062", "S063", "W010", "W011",
...
const THIN_CODES: &[&str] = &[
    ...
    "E421", "E422", "E423", "E424", "E425", "E426", "E427", "E428", "E429", "E430", "E431", "E999",
...
const SHARED: &[&str] = &[
    ...
    "E397", "E398", "E399", "E400", "E401", "E402", "E403", "E404", "E405", "E406", "E407", "E408",
    "E409", "E410", "E411", "E412", "E413", "E414", "E415", "E416", "E417", "E418", "E419", "E420",
    "E421", "E422", "E423", "E424", "E425", "E426", "E427", "E428", "E429", "E430", "E431", "W022",
...
const SKIP_KEYS: &[&str] = &[
    "E186", "E187", "E188", "E189", "E190", "E191", "S008", "S009", "S010", "S011", "S012", "S013",
    "S014", "S020", "S035", "S038", "S040", "S053", "S054", "S062", "S063", "W186", "W187",
];
...
fn known_codes_matches_the_rust_keys() {
    assert_eq!(SHARED.len(), 288);
    assert_eq!(ADDED.len(), 27);
    assert_eq!(SKIP_KEYS.len(), 23);
    assert_eq!(THIN_CODES.len(), 315);
    assert_eq!(RUST_CODES.len(), 338);
...
fn cli_explain_list() {
    ...
    assert_eq!(
        ...
        Some("338 codes. Run `dygnosis explain <CODE>` for details.")
    );
