...
const RUST_CODES: &[&str] = &[
    ...
    "E240", "E999", "I050", "S002", "S003", "S004", "S005", "S008",
    "S009", "S010", "S011", "S012", "S013", "S014", "S015", "S016",
    "S020", "S028", "S029", "S030", "S031", "S032", "S033", "S034",
    "S035", "S036", "S037", "S038", "S039", "S040", "S041", "S044",
    "S046", "S047", "S049", "S050", "S051", "S052", "S053", "S054",
    "S055", "S056", "S057", "S058", "S059", "S060", "W010", "W011",
    "W012", "W013", "W020", "W022", "W031", "W042", "W051", "W052",
    "W054", "W055", "W056", "W057", "W060", "W061", "W062", "W070",
    "W091", "W092", "W094", "W102", "W110", "W112", "W120", "W121",
    "W122", "W131", "W140", "W150", "W160", "W170", "W186", "W200",
    "W201", "W202"
];
...
const THIN_CODES: &[&str] = &[
    ...
    "E237", "E238", "E239", "E240", "W022", "W031", "W042", "W121",
    "W131", "W150", "W170", "W200", "W201", "W202", "E999", "I050",
...
const SKIP_KEYS: &[&str] = &[
    ...
    "S015", "S016", "S020", "S028", "S029", "S030", "S031", "S032",
    "S033", "S034", "S035", "S036", "S037", "S038", "S039", "S040",
    "S041", "S044", "S046", "S047", "S049", "S050", "S051", "S052",
...
#[test]
fn known_codes_is_exactly_the_170_rust_keys() {
    assert_eq!(SHARED.len(), 94);
    assert_eq!(ADDED.len(), 27);
    assert_eq!(SKIP_KEYS.len(), 49);
    assert_eq!(THIN_CODES.len(), 121);
    assert_eq!(RUST_CODES.len(), 170);
...
fn cli_explain_list() {
    ...
    assert_eq!(
        ...
        Some("170 codes. Run `dygnosis explain <CODE>` for details.")
    );
