...
const HONESTY_FIRE: &[HonestyRow] = &[
    ...
    HonestyRow {
        code: "E111",
        fixture: "d_shocks/e111_cov_corr.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "covariance or correlation shock on variable pair (u, e) declared twice",
        our_needle: "covariance or correlation shock on variable pair (u, e) declared twice",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E393",
        fixture: "d_shocks/e393_skew_single.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "shocks: skewness of e declared twice",
        our_needle: "shocks: skewness of e declared twice",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E394",
        fixture: "d_shocks/e394_skew_triple.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "shocks: co-skewness of (v, e, u) declared twice",
        our_needle: "shocks: co-skewness of (v, e, u) declared twice",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E130",
    ...
    HonestyRow {
        code: "E343",
        fixture: "d_shocks/e343_det_count.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "number of periods is different from number of shock values",
    ...
    HonestyRow {
        code: "E344",
        fixture: "d_shocks/e344_det_duplicate.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "shocks/conditional_forecast_paths: variable e declared twice",
        our_needle: "shocks/conditional_forecast_paths: variable e declared twice",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E395",
        fixture: "d_shocks/e395_reversed_period.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "Can't have first period index greater than second index in range specification",
        our_needle: "Can't have first period index greater than second index in range specification",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E396",
        fixture: "d_shocks/e396_regular_add.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "shocks: 'add' keyword not allowed unless 'learnt_in' option with value >1 is passed",
        our_needle: "shocks: 'add' keyword not allowed unless 'learnt_in' option with value >1 is passed",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E397",
        fixture: "d_shocks/e397_mshocks_add.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "mshocks: 'add' keyword not allowed",
        our_needle: "mshocks: 'add' keyword not allowed",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E398",
        fixture: "d_shocks/e398_surprise_add.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "shocks(surprise): 'add' keyword not allowed",
        our_needle: "shocks(surprise): 'add' keyword not allowed",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E399",
        fixture: "d_shocks/e399_surprise_date.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "shocks(surprise): dates are not allowed",
        our_needle: "shocks(surprise): dates are not allowed",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E400",
        fixture: "d_shocks/e400_learnt_zero.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "shocks: value '0' is not allowed for 'learnt_in' option",
        our_needle: "shocks: value '0' is not allowed for 'learnt_in' option",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E401",
        fixture: "d_shocks/e401_learnt_early.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "shocks: for variable e, shock period (2) is earlier",
        our_needle: "shocks: for variable e, shock period (2) is earlier",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E402",
        fixture: "d_shocks/e402_hetero_duplicate.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "heteroskedastic_shocks: variable e declared twice",
        our_needle: "heteroskedastic_shocks: variable e declared twice",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E403",
        fixture: "d_shocks/e403_hetero_count.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "heteroskedastic_shocks: variable e: number of periods is different",
        our_needle: "heteroskedastic_shocks: variable e: number of periods is different",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E404",
        fixture: "d_shocks/e404_path_count.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "shock_paths: variable e: number of periods is different",
        our_needle: "shock_paths: variable e: number of periods is different",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E405",
        fixture: "d_shocks/e405_path_lag.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "shock_paths: a lag of 1 is not allowed at period 1",
        our_needle: "shock_paths: a lag of 1 is not allowed at period 1",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E406",
        fixture: "d_shocks/e406_control_count.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "The number of periods is different from the number of values",
        our_needle: "The number of periods is different from the number of values",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E407",
        fixture: "d_shocks/e407_path_bare_nonparam.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "In the shock_paths block, parameters are the only symbols allowed without a namespace-qualifier",
        our_needle: "In the shock_paths block, parameters are the only symbols allowed without a namespace-qualifier",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E408",
        fixture: "d_shocks/e408_self_lead.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "The syntax self.u cannot be used with a lead",
        our_needle: "The syntax self.u cannot be used with a lead",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E409",
        fixture: "d_shocks/e409_self_nonint.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "Symbol self.u is being treated as if it were a function",
        our_needle: "Symbol self.u is being treated as if it were a function",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E410",
        fixture: "d_shocks/e410_self_arity.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "The parenthesis after self.u should only include a lag",
        our_needle: "The parenthesis after self.u should only include a lag",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E411",
        fixture: "d_shocks/e411_prev_default.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "The syntax prev.u is not accepted in a 'shock_paths' block without the 'learnt_in' option",
        our_needle: "The syntax prev.u is not accepted in a 'shock_paths' block without the 'learnt_in' option",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E412",
        fixture: "d_shocks/e412_learnt_ref_zero.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "The syntax learnt_in(0).u is not accepted",
        our_needle: "The syntax learnt_in(0).u is not accepted",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E413",
        fixture: "d_shocks/e413_learnt_ref_equal.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "The syntax learnt_in(2).u is not accepted in a 'shock_paths' block",
        our_needle: "The syntax learnt_in(2).u is not accepted in a 'shock_paths' block",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E414",
        fixture: "d_shocks/e414_db_duplicate.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "Database 'db' already declared",
        our_needle: "Database 'db' already declared",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E415",
        fixture: "d_shocks/e415_db_unknown.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "Unknown database: db.",
        our_needle: "Unknown database: db.",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E416",
        fixture: "d_shocks/e416_controlled_namespace.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "The syntax self.e is not accepted in an 'endogenize' stanza",
        our_needle: "The syntax self.e is not accepted in an 'endogenize' stanza",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E417",
        fixture: "d_shocks/e417_endval_add.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "endval: 'e += ...' line not allowed unless 'learnt_in' option with value >1 or date is passed",
        our_needle: "endval: 'e += ...' line not allowed unless 'learnt_in' option with value >1 or date is passed",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E418",
        fixture: "d_shocks/e418_endval_zero.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "endval: value '0' is not allowed for 'learnt_in' option",
        our_needle: "endval: value '0' is not allowed for 'learnt_in' option",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E419",
        fixture: "d_shocks/e419_endval_type.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "endval(learnt_in=...): y is not an exogenous variable",
        our_needle: "endval(learnt_in=...): y is not an exogenous variable",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E420",
        fixture: "d_shocks/e420_self_circular.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "in the definition of 'e' in a 'shock_paths' block, the use of 'self.e' without a lag",
        our_needle: "in the definition of 'e' in a 'shock_paths' block, the use of 'self.e' without a lag",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E421",
        fixture: "d_shocks/e421_paths_zero.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "Value '0' is not allowed for 'learnt_in' option",
        our_needle: "Value '0' is not allowed for 'learnt_in' option",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E422",
        fixture: "d_shocks/e422_shocks_gate.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "the 'shocks(learnt_in=…)' block can only be used",
        our_needle: "the 'shocks(learnt_in=…)' block can only be used",
        stage: JsonStage::Transform,
    },
    HonestyRow {
        code: "E423",
        fixture: "d_shocks/e423_endval_gate.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "the 'endval(learnt_in=…)' block can only be used",
        our_needle: "the 'endval(learnt_in=…)' block can only be used",
        stage: JsonStage::Transform,
    },
    HonestyRow {
        code: "E424",
        fixture: "d_shocks/e424_pfc_gate.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "the 'perfect_foresight_controlled_paths(learnt_in=…)' block can only be used",
        our_needle: "the 'perfect_foresight_controlled_paths(learnt_in=…)' block can only be used",
        stage: JsonStage::Transform,
    },
    HonestyRow {
        code: "E425",
        fixture: "d_shocks/e425_paths_gate.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "the 'shock_paths(learnt_in=…)' block can only be used",
        our_needle: "the 'shock_paths(learnt_in=…)' block can only be used",
        stage: JsonStage::Transform,
    },
    HonestyRow {
        code: "E058",
        fixture: "d_shocks/e058_det_unknown.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "Unknown symbol: z.",
        our_needle: "Unknown symbol: z.",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E387",
        fixture: "d_shocks/e387_det_wrong.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "y is not exogenous.",
    ...
    HonestyRow {
        code: "E317",
        fixture: "d_shocks/e317_control_wrong.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "e is not endogenous.",
    ...
    HonestyRow {
        code: "E058",
        fixture: "d_shocks/e058_irf_unknown.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "Unknown symbol: bad",
        our_needle: "Unknown symbol: bad",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E240",
        fixture: "d_shocks/e240_irf_wrong.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "Variables passed to irf_shocks must be exogenous. Caused by: y",
        our_needle: "Variables passed to irf_shocks must be exogenous. Caused by: y",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E240",
        fixture: "d_shocks/e240_est_irf_wrong.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "Variables passed to irf_shocks must be exogenous. Caused by: y",
    ...
    HonestyRow {
        code: "E001",
        fixture: "d_shocks/e001_irf_negative.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "syntax error, unexpected MINUS, expecting INT_NUMBER",
        our_needle: "syntax error, unexpected MINUS, expecting INT_NUMBER",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E001",
        fixture: "d_shocks/e001_irf_empty.mod",
        kind: HonestyKind::Error {
            workspace_only: false,
        },
        their_needle: "syntax error, unexpected ')'",
        our_needle: "syntax error, unexpected ')'",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E271",
        fixture: "d_shocks/e271_mshocks_option.mod",
        kind: HonestyKind::Error { workspace_only: false },
        their_needle: "The 'overwrite' option is declared multiple times",
        our_needle: "The 'overwrite' option is declared multiple times",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E271",
        fixture: "d_shocks/e271_path_option.mod",
        kind: HonestyKind::Error { workspace_only: false },
        their_needle: "The 'overwrite' option is declared multiple times",
        our_needle: "The 'overwrite' option is declared multiple times",
        stage: JsonStage::Check,
    ...
    HonestyRow {
        code: "E058",
        fixture: "d_shocks/e058_stochastic_unknown.mod",
        kind: HonestyKind::Error { workspace_only: false },
        their_needle: "Unknown symbol: z.",
        our_needle: "Unknown symbol: z.",
        stage: JsonStage::Check,
    ...
    HonestyRow {
        code: "E001",
        fixture: "d_shocks/e001_path_empty_lag.mod",
        kind: HonestyKind::Error { workspace_only: false },
        their_needle: "syntax error, unexpected ')'",
        our_needle: "syntax error, unexpected ')'",
        stage: JsonStage::Check,
    ...
    HonestyRow {
        code: "E001",
        fixture: "d_shocks/e001_path_learnt_comma.mod",
        kind: HonestyKind::Error { workspace_only: false },
        their_needle: "syntax error, unexpected COMMA",
        our_needle: "syntax error, unexpected COMMA",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E409",
        fixture: "d_shocks/e409_symbol_product.mod",
        kind: HonestyKind::Error { workspace_only: false },
        their_needle: "Symbol self.u is being treated as if it were a function",
        our_needle: "Symbol self.u is being treated as if it were a function",
        stage: JsonStage::Check,
    ...
    HonestyRow {
        code: "E409",
        fixture: "d_shocks/e409_decimal_lag.mod",
        kind: HonestyKind::Error { workspace_only: false },
        their_needle: "Symbol self.u is being treated as if it were a function",
        our_needle: "Symbol self.u is being treated as if it were a function",
        stage: JsonStage::Check,
    ...
    HonestyRow {
        code: "E001",
        fixture: "d_shocks/e001_irf_trailing_comma.mod",
        kind: HonestyKind::Error { workspace_only: false },
        their_needle: "syntax error, unexpected ')'",
        our_needle: "syntax error, unexpected ')'",
        stage: JsonStage::Check,
    ...
    HonestyRow {
        code: "E001",
        fixture: "d_shocks/e001_irf_number.mod",
        kind: HonestyKind::Error { workspace_only: false },
        their_needle: "syntax error, unexpected INT_NUMBER",
        our_needle: "syntax error, unexpected INT_NUMBER",
        stage: JsonStage::Check,
    },
    HonestyRow {
        code: "E271",
        fixture: "d_shocks/e271_irf_repeat.mod",
        kind: HonestyKind::Error { workspace_only: false },
        their_needle: "option irf declared twice",
