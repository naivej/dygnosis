...
An `@#include` directive names a file that could not be opened. They refuse: `Could not open F. The following directories were searched` (then the directories actually searched).
