...
The Dynare parser could not interpret the source. The diagnostic range points at the offending token or the nearest recoverable position. They refuse with a generic bison `ERROR` at a location.
