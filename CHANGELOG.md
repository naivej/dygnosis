...
- Information codes `I208`, `I209`, and `I210` summarize missing equation `name` tags, missing declaration `long_name`s, and numeric literals written in model equations. Each note is one count for the compilation unit. They are writing preferences, not Dynare refusals. An unresolved include or macro expansion withholds the count.
